...
lambda_1_plot_values_nllc = [result[1] for result in nllc_results]
lambda_2_plot_values_nllc = [result[2] for result in nllc_results]

# Plot lambda_2 vs. asif for NLLc
plt.plot(asif_plot_values_nllc, lambda_1_plot_values_nllc, marker='x', label='NLLc Data', color='lightcoral')
