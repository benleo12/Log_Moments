...
parser.add_argument('--n_samp', type=int, default=10000, help='Number of samples to process')

# Parse arguments
args = parser.parse_args()

# Use args.n_samp to get the number of samples from the parsed command-line arguments
n_samp = args.n_samp


alphas = AlphaS(91.1876,0.03,order=1)
hardxs = eetojj(alphas)
shower = Shower(alphas,t0=10**-6)
...
import csv
# Save thrust values to a CSV file
